  ...
  buttonJSON: [
    {
      ...
      picId: "wframe",
      funk: function(){
        // world.level.panelInstructions = new Panel( world, 1)
        document.getElementById("firstPanel").parentNode.removeChild(document.getElementById("firstPanel"))
      }
    },{
      name: "Quit Button",
  ...
  buttonJSON: [
    {
      ...
      picId: "back",
      funk: function(){
        // world.level.panelStart = new Panel( world, 0)
  ...
  buttonJSON: [
    {
      ...
      funk: function(){
        document.getElementById("endPanel").parentNode.removeChild(document.getElementById("endPanel"))
          // world.level.panelQuit = new Panel( world, 2)
      }
    },{
  name: "Credits Button",
      id: "creditsButton",
      ...
      picId: "wframe",
      funk: function(){
        // world.level.panelCredits = new Panel( world, 3)
        document.getElementById("endPanel").parentNode.removeChild(document.getElementById("endPanel"))
      }
    }]
},{
  ...
  buttonJSON: [
    {
      ...
      funk: function(){
        //world.level.panelQuit = new Panel(world, 2)
        document.getElementById("creditesPanel").parentNode.removeChild(document.getElementById("creditsPanel"))
      }
    }]
}]